          ...
          actions: {
            ...
            items: {
              ...
              properties: {
                ...
                name: { type: 'string', description: 'For add_cardio_session: the cardio name as Lauren would say it (e.g. "Spin class", "HIIT", "Run", "Yoga"). Keep it short and human. For create_custom_workout: a short name for the workout.' },
