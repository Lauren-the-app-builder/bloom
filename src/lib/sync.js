...
const KV_KEYS = ['schedule', 'lastSessions', 'coachContext', 'unit', 'exerciseNotes', 'focusLiftName', 'wrenSetsOverrides', 'nourishCalorieGoal', 'nourishWeightLog', 'nourishPhase', 'wrenNotes', 'cardioSessions', 'injuryWeeks', 'skippedSessions', 'offWeeks'];
